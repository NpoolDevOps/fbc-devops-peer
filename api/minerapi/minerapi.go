			...
			if !inSectorState {
				if strings.Contains(lineStr, "Proving: ") {
					...
					if strings.Contains(lineStr, "Faulty, ") {
						...
						setUnitTiB(info.Faulty, lineStr)
					}
				}
			}
...
func setUnitTiB(value float64, line string) {
